...
## Test case: Add to-do, event, deadline, and fallback to-do tasks

### Aim

Verify that the parser creates to-do, deadline, and event tasks, and that unmatched input defaults to a to-do task.
...
## Test case: Reject invalid and repeated task state changes

### Aim

Verify that marking and unmarking an out-of-range task number reports an error, and that repeated marking or unmarking reports the existing task state.
